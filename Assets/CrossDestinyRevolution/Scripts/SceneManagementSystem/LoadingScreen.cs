...
namespace CDR.SceneManagementSystem
{
    public class LoadingScreen : MonoBehaviour, IUIElement
    {
        ...
        public void Hide()
        {
            ...
            _HideCoroutine = StartCoroutine(VFXUtilities.LinearEaseOut(OnFadeEvent, () => Time.unscaledDeltaTime, null, _FadeOutTime, OnAfterFadeOut));
        }
        ...
        public void Show()
        {
            ...
            _ShowCoroutine = StartCoroutine(VFXUtilities.LinearEaseIn(OnFadeEvent, () => Time.unscaledDeltaTime, null, _FadeInTime, OnAfterFadeIn));
        }
    }
}